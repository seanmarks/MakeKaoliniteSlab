...
SimulationBox::SimulationBox(const double l_x, const double l_y, const double l_z)
{
	setLengths(l_x, l_y, l_z);
}


SimulationBox::SimulationBox(const Real3& lengths)
{
	setLengths(lengths[X_DIM], lengths[Y_DIM], lengths[Z_DIM]);
}
